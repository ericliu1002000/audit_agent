"""
Django settings for audit_agent project.
...
WSGI_APPLICATION = 'audit_agent.wsgi.application'
...
PRICE_AUDIT_MILVUS_COLLECTION = os.getenv(
    "PRICE_AUDIT_MILVUS_COLLECTION", "price_audit_standard_price_vectors"
)
...
# Media files (uploaded Excel, etc.)
...
"""
初始化数据库
CREATE DATABASE IF NOT EXISTS `audit_agent`
