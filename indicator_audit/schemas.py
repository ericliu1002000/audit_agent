...
def get_ai_extraction_schema():
    ...
    try:
        return json.dumps(
            PerformanceDeclarationSchema.model_json_schema(),
            indent=2,
            ensure_ascii=False,
        )
    except AttributeError:
        # 兼容 Pydantic V1
        return PerformanceDeclarationSchema.schema_json(
